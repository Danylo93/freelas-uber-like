...
export default function Index() {
  ...
  const SplashScreen = () => {
    return (
      <View style={styles.splashContainer} testID="provider-splash-screen">
        <Animated.View
          style={[
        ...
        <Animated.View style={[styles.textContainer, { opacity: fadeAnim }]}>
          <Text style={styles.appName} testID="provider-splash-title">Freelas Profissional</Text>
          <Text style={styles.tagline} testID="provider-splash-tagline">🔧 Conectando você aos melhores profissionais</Text>
        </Animated.View>
      </View>
    );
  };
